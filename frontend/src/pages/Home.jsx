...
const Home = () => {
    ...
    <>
                    ...
                    <div>
                        <div className="lg:w-[570px]">
                            ...
                            <p className="text__para"> Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Eligendi eaque, possimus quos ullam laboriosam quis facere.
                                Iusto pariatur voluptate, consequuntur corrupti quasi necessitatibus,
                                doloremque amet mollitia, qui sunt autem? Minima.</p>
        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px]
            lg:mt-[55px]">
        ...
        { /* =========== Our Great Doctor section start ========== */}
